...
function Riddle() {
  ...
  return (
    <div className='flex flex-col gap-4 px-6 justify-center items-center'>
            ...
            <div onClick={handleCLick} className='px-10 mt-6 py-2 lg:py-4 bg-slate-300 w-full rounded-md active:bg-slate-400 cursor-pointer text-center hover:tracking-wider transition-all ease-in-out duration-500 select-none'>Click here to get a riddle</div>
