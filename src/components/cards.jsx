...
function Cards() {
  return (
    <div id='cards' className='w-full h:[100vh] lg:h-[80vh] bg-zinc-200 flex flex-col lg:flex-row items-center px-32 gap-5 sticky -top-[52.5rem] lg:-top-16 z-10 pb-10 pt-10'>
        ...
        <div className="container2 flex flex-col lg:flex-row gap-5 lg:w-1/2 lg:h-[50vh]">
              ...
              <div className="card2 rounded-xl w-[90vw] lg:w-full h-[52vh] lg:h-full bg-[#212121] lg:block overflow-hidden">
